...
let numerosOrdenados = numeros.sort(function (a, b) {
  return a - b;
}); //Aquí lo que sucede es que la funcion realiza la sustraccion de 2 valores, y de ahí comprueba cual de los dos es el maschico y los ordena.
//NOTA: LAS FUNCIONES DE LOS COLLBAKS SON ANONIMAS
